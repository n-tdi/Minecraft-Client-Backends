...
public class AvailableCosmeticServiceImpl implements AvailableCosmeticService {
    ...
    @Override
    public void createCosmetic(final String p_displayName, final boolean p_animated, final Integer p_frames, final String p_assetLocation) {
        ...
        m_availableCosmeticRepository.save(availableCosmeticEntity);
    }
}
